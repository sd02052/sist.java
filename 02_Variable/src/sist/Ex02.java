...
public class Ex02 {
	...
	public static void main(String[] args) {
		...
		// 자료형의 형변환(명시적 형변환)- 반드시 기재를 해줘야 한다. 큰걸 작은곳으로 넣어야 하기 때문에
		byte su2 = (byte) num2;
		...
		double avg= 91.34666666666666666666666666666666666666666666666666666666666666;
