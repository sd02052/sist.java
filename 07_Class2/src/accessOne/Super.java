 ...
 * 					다른 패키지의 상속 관계에 있는 클래스의 멤버까지 접근이 가능함.
 * 
 * 4. public : - 모든 클래스에서 접근이 가능함.
 * 				- 같은 클래스의 멤버, 같은 패키지 안의 다른 클래스의 멤버,
 * 				다른 패키지의 상속 관계에 있는 클래스의 멤버, 다른 패키지의 
 * 				클래스의 멤버까지 접근이 가능함.
 * 
