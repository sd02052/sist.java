 ...
 * - 기본자료형보다 객체로 저장하기 대문에 좀 더 다양한 기능을 제공하기 위해 사용함.
...
public class Ex01 {
	public static void main(String[] args) {
		...
		// 형변환이 자유롭다.
		System.out.println("int형 >>> " + in3.intValue()); // 언박싱
		System.out.println("float형 >>> " + in3.floatValue()); // int형을 float형으로 쉽게 변환 가능.
		System.out.println();
		...
		// parseInt() : 문자열 -> 숫자
		System.out.println("문자열 -> 숫자 >>> " + (Integer.parseInt(in3.toString()) + 44));
